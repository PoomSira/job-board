                    ...
                    <div className="flex items-center gap-y-4">
                        <div className="flex items-center gap-x-2">
                            <span className="flex items-center lg:text-5xl text-3xl">
                                <button className="rounded-full py-1 px-1 text-white bg-primary lg:text-5xl text-3xl outline-none border-none">
                                    Job
                                </button>
                                <p className="font-semibold leading-tight"> Search</p>
                            </span>
                        </div>
                    </div>
